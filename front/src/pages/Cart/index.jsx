...
import {reqInstance, apiUrl} from "../../services/authService";
...
const Cart = () => {
    ...
    const clearCart = React.useCallback(() => {
        if (window.confirm('Вы действительно хотите очисить корзину?')) {
                ...
                <span>
                  ...
                  Сумма заказа: <b>{totalPrice} ₽</b>
                            ...
                            <div class="cart__bottom-buttons">
                                <Link to="/menu"><a className="button button--outline button--add go-back-btn">
                                    <svg
                                        width="8"
                                        height="14"
                                        viewBox="0 0 8 14"
